...
static const AVOption avformat_options[] = {/*AVFORMAT对应的可配置OPT*/
...
{"formatprobesize", "number of bytes to probe file format", OFFSET(format_probesize), AV_OPT_TYPE_INT, {.i64 = PROBE_BUF_MAX}, 0, INT_MAX-1, D},/*PROBE文件格式时读多少字节*/
